...
(require-option "orgfile" args)
(require-option "htmlfile" args)
...
(setq tempfile (format "%s.temp" (gethash "orgfile" args)))
(copy-file (gethash "orgfile" args) tempfile t)
(find-file tempfile)
(org-mode)
(org-export-as-html 3 nil nil "temp.html")
(write-file (gethash "htmlfile" args))
